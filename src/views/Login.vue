    ...
    <div class="container">
      ...
      >
        ...
        <el-form-item label="服务器">
          <el-input prefix-icon="myicon myicon-key" v-model="urlId"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    loginSubmit(formName) {
       this.loading = true;
      console.log(this.LoginForm.userpsw);
      // this.$store.dispatch("setIpHost", this.LoginForm.urlId);
      localStorage.setItem("setIpHost", this.urlId);
